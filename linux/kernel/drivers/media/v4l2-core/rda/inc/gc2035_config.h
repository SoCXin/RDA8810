...
static struct sensor_reg init_gc2035[] =
{
	...
	//analog
	{0x0a,0x00,BIT,0}, //row start
	{0x0c,0x00,BIT,0}, //col start
	{0x0d,0x04,BIT,0},
	{0x0e,0xc0,BIT,0},
	{0x0f,0x06,BIT,0}, //Window setting
	{0x10,0x58,BIT,0},
	{0x17,0x14,BIT,0}, //[0]mirror [1]flip
	{0x18,0x0e,BIT,0}, //0a 2012.10.26
	{0x19,0x0c,BIT,0}, //AD pipe number
	{0x1a,0x01,BIT,0}, //CISCTL mode4
	{0x1b,0x8b,BIT,0},
	{0x1c,0x05,BIT,0}, //add by lanking
	{0x1e,0x88,BIT,0}, //analog mode1 [7] tx-high en [5:3]COL_bias
	{0x1f,0x08,BIT,0}, //[3] tx-low en
	{0x20,0x05,BIT,0}, //[0]adclk mode, 0x[1]rowclk_MODE [2]rsthigh_en
	{0x21,0x0f,BIT,0}, //[6:4]rsg
	{0x22,0xd0,BIT,0}, //[3:0]vref
	{0x23,0xc3,BIT,0}, //f3//ADC_r
	{0x24,0x3f,BIT,0}, //pad drive 16

	//AEC
	{0xfe,0x01,BIT,0},
	{0x11,0x20,BIT,0}, //AEC_out_slope, 0x
	{0x1f,0xc0,BIT,0}, //max_post_gain
	{0x20,0x60,BIT,0}, //max_pre_gain
	{0x47,0x30,BIT,0}, //AEC_outdoor_th
	{0x0b,0x10,BIT,0},
	{0x13,0x75,BIT,0}, //y_target
	{0xfe,0x00,BIT,0},
	...
	{0x30,0x50,BIT,0},
	{0xfe,0x00,BIT,0},
	{0xb6,0x03,BIT,0}, //AEC enable
	{0xfe,0x00,BIT,0},

	//BLK
	{0x3f,0x00,BIT,0}, //prc close
	{0x40,0x77,BIT,0},
	{0x42,0x7f,BIT,0},
	{0x43,0x30,BIT,0},
	{0x5c,0x08,BIT,0},
	...
	{0x80,0xff,BIT,0},
	{0x81,0x26,BIT,0}, //skin_Y 8c_debug
	{0x87,0x90,BIT,0}, //[7]middle gamma
	{0x84,0x02,BIT,0}, //output put foramat
	{0x86,0x07,BIT,0}, //sync plority
	{0x8b,0xbc,BIT,0},
	{0xb0,0x80,BIT,0}, //globle gain
	{0xc0,0x40,BIT,0}, //Yuv bypass
	...
	{0xfe,0x02,BIT,0},
	{0xc0,0x01,BIT,0},
	{0xc1,0x40,BIT,0}, //Green_cc for d
	{0xc2,0xfc,BIT,0},
	{0xc3,0x05,BIT,0},
	{0xc4,0xec,BIT,0},
	{0xc5,0x42,BIT,0},
	{0xc6,0xf8,BIT,0},
	{0xc7,0x40,BIT,0}, //for cwf
	{0xc8,0xf8,BIT,0},
	{0xc9,0x06,BIT,0},
	{0xca,0xfd,BIT,0},
	{0xcb,0x3e,BIT,0},
	{0xcc,0xf3,BIT,0},
	{0xcd,0x36,BIT,0}, //for A
	{0xce,0xf6,BIT,0},
	{0xcf,0x04,BIT,0},
	{0xe3,0x0c,BIT,0},
	{0xe4,0x44,BIT,0},
	...
	//awb
	{0xfe,0x01,BIT,0},
	{0x50,0x88,BIT,0}, //[6]green mode
	{0x52,0x40,BIT,0},
	{0x54,0x60,BIT,0},
	{0x56,0x06,BIT,0},
	{0x57,0x20,BIT,0}, //pre adjust
	{0x58,0x01,BIT,0},
	{0x5b,0x02,BIT,0}, //AWB_gain_delta
	{0x61,0xaa,BIT,0}, //R/G stand
	{0x62,0xaa,BIT,0}, //R/G stand
	{0x71,0x00,BIT,0},
	{0x74,0x10,BIT,0}, //AWB_C_max
	{0x77,0x08,BIT,0}, //AWB_p2_x
	{0x78,0xfd,BIT,0}, //AWB_p2_y
	{0x86,0x30,BIT,0},
	{0x87,0x00,BIT,0},
	{0x88,0x04,BIT,0}, //[1]dark mode
	{0x8a,0xc0,BIT,0}, //awb move mode
	{0x89,0x75,BIT,0},
	{0x84,0x08,BIT,0}, //auto_window
	{0x8b,0x00,BIT,0}, //awb compare luma
	{0x8d,0x70,BIT,0}, //awb gain limit R
	{0x8e,0x70,BIT,0}, //G
	{0x8f,0xf4,BIT,0}, //B
	{0xfe,0x00,BIT,0},
	{0x82,0x02,BIT,0}, //awb_en
	//awb end
	...
	{0xab,0x31,BIT,0},
	{0xa9,0x6f,BIT,0},
	{0xb0,0x99,BIT,0}, //edge effect slope low
	...
	{0x84,0x45,BIT,0},
	//YCP
	{0xd1,0x38,BIT,0}, //saturation_cb
	{0xd2,0x38,BIT,0}, //saturation_Cr
	{0xd3,0x40,BIT,0}, //contrast Ó
	...
	//size
	{0xfe,0x03,BIT,0},
	{0x43,0x06,BIT,0}, //output buf width
	{0x42,0x40,BIT,0},
	{0x41,0x02,BIT,0}, //Pclk_polarity
	{0x40,0x40,BIT,0},
	{0x17,0x00,BIT,0}, //widv
	{0xfe,0x00,BIT,100},
	//output DVP
	{0xfe,0x00,BIT,0},
	{0x82,0xfe,BIT,0},
...
static struct sensor_reg test_gc2035[] =
{
	{0xfe,0x00,0},
	{0x18,0x06,0},
	{0x80,0x08,0},
...
static void gc2035_sensor_test(void)
{
	sensor_write_group(test_gc2035, ARRAY_ROW(test_gc2035));
}
...
static struct sensor_ops gc2035_ops = {
	...
	.sensor_test = gc2035_sensor_test,
	.start		= NULL,
	.stop		= NULL
};
