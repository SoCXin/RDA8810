#ifndef __ASM_ARCH_RDA_IOMAP_RDA8820_H
#define __ASM_ARCH_RDA_IOMAP_RDA8820_H

#include <asm/sizes.h>

/*
 * RDA8820 internal I/O mappings
 *
...
#define RDA_MODEM_XCPU_PHYS   0x11A17000
...
#define RDA_CAMERA2_PHYS      0x204C0000
...
#define RDA_CAMERA2_DMA_BASE  (RDA_CAMERA_DMA_BASE + RDA_CAMERA_DMA_SIZE)
#define RDA_CAMERA2_DMA_PHYS  0x20860000
#define RDA_CAMERA2_DMA_SIZE  SZ_64K

#define RDA_GPU_MALI_BASE     (RDA_CAMERA2_DMA_BASE + RDA_CAMERA2_DMA_SIZE)
#define RDA_GPU_MALI_PHYS     0x20870000
#define RDA_GPU_MALI_SIZE     SZ_64K

#define RDA_AES_BASE          (RDA_GPU_MALI_BASE + RDA_GPU_MALI_SIZE)
#define RDA_AES_PHYS          0x20880000
#define RDA_AES_SIZE          SZ_64K

#define RDA_VPU_JPEG_BASE     (RDA_AES_BASE + RDA_AES_SIZE)
#define RDA_VPU_JPEG_PHYS     0x20890000
#define RDA_VPU_JPEG_SIZE     SZ_64K

/* APB1 */
#define RDA_SYSCTRL_BASE      (RDA_VPU_JPEG_BASE + RDA_VPU_JPEG_SIZE)
...
#define RDA_KEYPAD_BASE       (RDA_TIMER_BASE + RDA_TIMER_SIZE)
...
#define RDA_GPIOC_BASE        (RDA_GPIOB_BASE + RDA_GPIOB_SIZE)
#define RDA_GPIOC_PHYS        0x20932000
#define RDA_GPIOC_SIZE        SZ_4K

#define RDA_GPIOD_BASE        (RDA_GPIOC_BASE + RDA_GPIOC_SIZE)
#define RDA_GPIOD_PHYS        0x20933000
#define RDA_GPIOD_SIZE        SZ_4K + SZ_16K + SZ_16K + SZ_16K

#define RDA_PWM_BASE          (RDA_GPIOD_BASE + RDA_GPIOD_SIZE)
#define RDA_PWM_PHYS          0x20940000
#define RDA_PWM_SIZE          SZ_64K

#define RDA_LVDS_BASE         (RDA_PWM_BASE + RDA_PWM_SIZE)
#define RDA_LVDS_PHYS         0x20950000
#define RDA_LVDS_SIZE         SZ_64K

#define RDA_TVCLK_BASE        (RDA_LVDS_BASE + RDA_LVDS_SIZE)
#define RDA_TVCLK_PHYS        0x20960000
#define RDA_TVCLK_SIZE        SZ_64K

#define RDA_GIC_BASE          (RDA_TVCLK_BASE + RDA_TVCLK_SIZE)
#define RDA_GIC_PHYS          0x20970000
#define RDA_GIC_SIZE          SZ_64K

#define RDA_COMREGS_BASE      (RDA_GIC_BASE + RDA_GIC_SIZE)
...
#define RDA_DMC400_SIZE       SZ_64K

#define RDA_DDRPHY_BASE       (RDA_DMC400_BASE + RDA_DMC400_SIZE)
#define RDA_DDRPHY_PHYS       0x209A0000
#define RDA_DDRPHY_SIZE       SZ_64K

#define RDA_PDCTRL_BASE       (RDA_DDRPHY_BASE + RDA_DDRPHY_SIZE)
#define RDA_PDCTRL_PHYS       0x209B0000
#define RDA_PDCTRL_SIZE       SZ_64K

#define RDA_ISP_BASE          (RDA_PDCTRL_BASE + RDA_PDCTRL_SIZE)
#define RDA_ISP_PHYS          0x209C0000
#define RDA_ISP_SIZE          SZ_64K

#define RDA_AIF2_BASE         (RDA_ISP_BASE + RDA_ISP_SIZE)
...
#define RDA_I2C1_BASE         (RDA_UART3_BASE + RDA_UART3_SIZE)
...
#define RDA_UART4_BASE        (RDA_I2C3_BASE + RDA_I2C3_SIZE)
#define RDA_UART4_PHYS        0x20AE0000
#define RDA_UART4_SIZE        SZ_64K

#define RDA_IFC_BASE          (RDA_UART4_BASE + RDA_UART4_SIZE)
#define RDA_IFC_PHYS          0x20AF0000
#define RDA_IFC_SIZE          SZ_64K

#endif /* __ASM_ARCH_RDA_IOMAP_RDA8820_H */
